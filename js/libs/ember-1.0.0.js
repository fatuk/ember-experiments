...
(function() {
    ...
    (function() {
        ...
        e = function(e, t, n) {
            ...
            if (n[e]) return n[e];
            n[e] = {};
            for (var i, o = r[e], a = o.deps, s = o.callback, u = [], c = 0, l = a.length; l > c; c++) "exports" === a[c] ? u.push(i = {}) : u.push(t(a[c]));
            var h = s.apply(this, u);
            return n[e] = i || h
        }
    })(),
    function() {
        ...
        Ember.lookup = Ember.lookup || this, r.Em = r.Ember = Em = Ember, Ember.isNamespace = !0, Ember.toString = function() {
            ...
            return null === e || void 0 === e || 0 === e.length && "function" != typeof e || "object" == typeof e && 0 === Ember.get(e, "length")
    ...
    function() {
        ...
        f && (e.prototype.__preventPlainObject__ = !0, e.prototype.toJSON = function() {}), Ember.meta = function(t, i) {
            var o = t[h];
            return i === !1 ? o || m : (o ? o.source !== t && (f || r(t, h, l), o = n(o), o.descs = n(o.descs), o.watching = n(o.watching), o.cache = {}, o.source = t, u && (o.values = n(o.values)), t[h] = o) : (f || r(t, h, l), o = new e(t), u && (o.values = {}), t[h] = o, o.descs.constructor = null), o)
        ...
        Ember.typeOf = function(e) {
            var t;
            return t = null === e || void 0 === e ? String(e) : d[E.call(e)] || "object", "function" === t ? Ember.Object && Ember.Object.detect(e) && (t = "class") : "object" === t && (t = e instanceof Error ? "error" : Ember.Object && e instanceof Ember.Object ? "instance" : "object"), t
        }
    }(),
    function() {
    ...
    function() {
        var e, t, r, n;
        n = Array.prototype.concat, e = Array.prototype.map || Ember.ArrayPolyfills.map, t = Array.prototype.forEach || Ember.ArrayPolyfills.forEach, r = Array.prototype.indexOf || Ember.ArrayPolyfills.indexOf;
        var i = Ember.EnumerableUtils = {
            ...
            replace: function(e, t, r, i) {
                if (e.replace) return e.replace(t, r, i);
                var o = n.apply([t, r], i);
                return e.splice.apply(e, o)
            },
    ...
    function() {
        ...
        o.create = function() {
            ...
            remove: function(t) {
                var r = this.keys,
                    n = this.values,
                    i = e(t);
                return n.hasOwnProperty(i) ? (r.remove(t), delete n[i], !0) : !1
            },
            has: function(t) {
                var r = this.values,
                    n = e(t);
        ...
        a.create = function(e) {
            return e ? new a(e) : new o
        }, a.prototype = Ember.create(o.prototype), a.prototype.get = function(e) {
            var t = this.has(e);
    ...
    function() {
        ...
        function t(t, n) {
            var i, s = a.test(n),
                u = !s && o.test(n);
            if ((!t || u) && (t = Ember.lookup), s && (n = n.slice(5)), t === Ember.lookup && (i = e(n), t = r(t, i), n = n.slice(i.length + 1)), !n || 0 === n.length) throw new Error("Invalid Path");
            return [t, n]
        }
        var r, n = Ember.META_KEY,
        ...
        r = function r(e, t) {
            if ("" === t) return e;
            if (t || "string" != typeof e || (t = e, e = null), !e || -1 !== t.indexOf(".")) return u(e, t);
            var r, o = e[n],
                a = o && o.descs[t];
            return a ? a.get(e, t) : (r = i && o && o.watching[t] > 0 ? o.values[t] : e[t], void 0 !== r || "object" != typeof e || t in e || "function" != typeof e.unknownProperty ? r : e.unknownProperty(t))
        }, Ember.config.overrideAccessors && (Ember.get = r, Ember.config.overrideAccessors(), r = Ember.get);
        var u = Ember._getPath = function(e, n) {
            var i, o, s, u, c;
            if (null === e && -1 === n.indexOf(".")) return r(Ember.lookup, n);
            for (i = a.test(n), (!e || i) && (s = t(e, n), e = s[0], n = s[1], s.length = 0), o = n.split("."), c = o.length, u = 0; e && c > u; u++)
                if (e = r(e, o[u], !0), e && e.isDestroyed) return void 0;
            return e
        };
        Ember.normalizeTuple = function(e, r) {
            return t(e, r)
        }, Ember.getWithDefault = function(e, t, n) {
            var i = r(e, t);
            return void 0 === i ? n : i
        }, Ember.get = r, Ember.getPath = Ember.deprecateFunc("getPath is deprecated since get now supports paths", Ember.get)
    }(),
    function() {
        function e(e, t, r) {
            ...
            if (o) {
                for (var s = o.length - 1; s >= 0; s--) {
                    var u = o[s][0],
                        ...
                        l = o[s][2],
                        h = o[s][3],
                        m = e(n, u, c); - 1 === m && (n.push([u, c, l, h]), a.push([u, c, l, h]))
                }
                return a
            }
        }
        ...
        function i(r, n, i, o, a) {
            ...
            var s = t(r, n),
                u = e(s, i, o); - 1 === u && (s.push([i, o, a, void 0]), "function" == typeof r.didAddListener && r.didAddListener(n, i, o))
        }

        function o(r, n, i, o) {
            function a(i, o) {
                var a = t(r, n),
                    s = e(a, i, o); - 1 !== s && (a.splice(s, 1), "function" == typeof r.didRemoveListener && r.didRemoveListener(n, i, o))
            }
        ...
        function a(r, n, i, o, a) {
            ...
            var c, l = t(r, n),
                h = e(l, i, o);
            return -1 !== h && (c = l[h].slice(), c[3] = !0, l[h] = c), Ember.tryFinally(s, u)
        }
        ...
        function s(r, n, i, o, a) {
            ...
            function u() {
                for (m = 0, f = p.length; f > m; m++) p[m][3] = void 0
            }
            o || "function" != typeof i || (o = i, i = null);
            var c, l, h, m, f, p = [];
            for (m = 0, f = n.length; f > m; m++) {
                c = n[m], l = t(r, c);
                var d = e(l, i, o); - 1 !== d && (h = l[d].slice(), h[3] = !0, l[d] = h, p.push(h))
            }
                ...
                for (var a = n.length - 1; a >= 0; a--)
                    if (n[a] && n[a][3] !== !0) {
                        var s = n[a][0],
                            u = n[a][1],
                            c = n[a][2];
                        c && o(e, t, s, u), s || (s = e), "string" == typeof u && (u = s[u]), r ? u.apply(s, r) : u.call(s)
                    }
                return !0
            }
        }
    ...
    function() {
        ...
        function r(e, t, r, n, i) {
            ...
            if (n[o] || (n[o] = {}), !n[o][r]) {
                ...
                if (s = s && s[r])
                    for (var u in s) {
                        var c = i.descs[u];
                        c && c._suspended === t || e(t, u)
                    }
            }
        }
        var n, i, o = Ember.meta,
            a = Ember.guidFor,
            s = Ember.tryFinally,
            u = Ember.sendEvent,
            c = Ember.listenersUnion,
            l = Ember.listenersDiff,
            h = Ember._ObserverSet,
            m = new h,
            f = new h,
            p = 0,
            d = Ember.propertyWillChange = function(t, r) {
                var n = o(t, !1),
                    i = n.watching[r] > 0 || "length" === r,
                    a = n.proto,
                    s = n.descs[r];
                i && a !== t && (s && s.willChange && s.willChange(t, r), e(t, r, n), E(t, r, n), w(t, r))
            }, b = Ember.propertyDidChange = function(e, r) {
                var n = o(e, !1),
                    i = n.watching[r] > 0 || "length" === r,
                    a = n.proto,
                    s = n.descs[r];
                a !== e && (s && s.didChange && s.didChange(e, r), (i || "length" === r) && (t(e, r, n), v(e, r, n), _(e, r)))
            }, E = function(e, t, r, n) {
                if (r.hasOwnProperty("chainWatchers")) {
                    var i = r.chainWatchers;
                    if (i = i[t])
                        for (var o = 0, a = i.length; a > o; o++) i[o].willChange(n)
                }
            }, v = function(e, t, r, n) {
                if (r.hasOwnProperty("chainWatchers")) {
                    var i = r.chainWatchers;
                    if (i = i[t])
                        for (var o = i.length - 1; o >= 0; o--) i[o].didChange(n)
                }
            };
        Ember.overrideChains = function(e, t, r) {
            v(e, t, r, !0)
        };
        var g = Ember.beginPropertyChanges = function() {
            p++
        }, y = Ember.endPropertyChanges = function() {
                p--, 0 >= p && (m.clear(), f.flush())
            };
        ...
        var w = function(e, t) {
            if (!e.isDestroying) {
                var r, n, i = t + ":before";
                p ? (r = m.add(e, t, i), n = l(e, i, r), u(e, i, [e, t], n)) : u(e, i, [e, t])
            }
        }, _ = function(e, t) {
                if (!e.isDestroying) {
                    var r, n = t + ":change";
                    p ? (r = f.add(e, t, n), c(e, n, r)) : u(e, n, [e, t])
                }
            }
    }(),
    function() {
        function e(e, t, r, o) {
            var a;
            if (a = t.slice(t.lastIndexOf(".") + 1), t = t.slice(0, t.length - (a.length + 1)), "this" !== t && (e = n(e, t)), !a || 0 === a.length) throw new Error("You passed an empty path");
            if (!e) {
                if (o) return;
        ...
        var t = Ember.META_KEY,
            ...
            n = Ember._getPath,
            i = function i(n, i, o, a) {
                if ("string" == typeof n && (o = i, i = n, n = null), !n || -1 !== i.indexOf(".")) return e(n, i, o, a);
                var s, u, c = n[t],
                    l = c && c.descs[i];
                return l ? l.set(n, i, o) : (s = "object" == typeof n && !(i in n), s && "function" == typeof n.setUnknownProperty ? n.setUnknownProperty(i, o) : c && c.watching[i] > 0 ? (u = r ? c.values[i] : n[i], o !== u && (Ember.propertyWillChange(n, i), r ? void 0 !== u || i in n ? c.values[i] = o : Ember.defineProperty(n, i, null, o) : n[i] = o, Ember.propertyDidChange(n, i))) : n[i] = o), o
            };
        Ember.config.overrideAccessors && (Ember.set = i, Ember.config.overrideAccessors(), i = Ember.set), Ember.set = i, Ember.setPath = Ember.deprecateFunc("setPath is deprecated since set now supports paths", Ember.set), Ember.trySet = function(e, t, r) {
            return i(e, t, r, !0)
    ...
    function() {
        ...
        Ember.defineProperty = function(e, a, s, u, c) {
            var l, h, m, f;
            return c || (c = t(e)), l = c.descs, h = c.descs[a], m = c.watching[a] > 0, h instanceof Ember.Descriptor && h.teardown(e, a), s instanceof Ember.Descriptor ? (f = s, l[a] = s, n && m ? r(e, a, {
                configurable: !0,
                enumerable: !0,
                writable: !0,
                value: void 0
            }) : e[a] = void 0, s.setup(e, a)) : (l[a] = void 0, null == s ? (f = u, n && m ? (c.values[a] = u, r(e, a, {
                configurable: !0,
                enumerable: !0,
                set: i,
                get: o(a)
            })) : e[a] = u) : (f = s, r(e, a, s))), m && Ember.overrideChains(e, a, c), e.didDefineProperty && e.didDefineProperty(e, a, f), this
        }
    }(),
    function() {
    ...
    function() {
        ...
        Ember.watchKey = function(i, o) {
            if ("length" !== o || "array" !== t(i)) {
                var a, s = e(i),
                    u = s.watching;
                u[o] ? u[o] = (u[o] || 0) + 1 : (u[o] = 1, a = s.descs[o], a && a.willWatch && a.willWatch(i, o), "function" == typeof i.willWatchProperty && i.willWatchProperty(o), r && o in i && (s.values[o] = i[o], n(i, o, {
                    configurable: !0,
                    enumerable: !0,
            ...
            var o, a = e(t),
                s = a.watching;
            1 === s[i] ? (s[i] = 0, o = a.descs[i], o && o.didUnwatch && o.didUnwatch(t, i), "function" == typeof t.didUnwatchProperty && t.didUnwatchProperty(i), r && i in t && (n(t, i, {
                configurable: !0,
                enumerable: !0,
                writable: !0,
                value: a.values[i]
            }), delete a.values[i])) : s[i] > 1 && s[i]--
        }
    }(),
    function() {
        function e(e) {
        ...
        var n = Ember.meta,
            ...
            h = Ember.propertyDidChange,
            m = /^([^\.\*]+)/,
            f = [];
        Ember.flushPendingChains = function() {
            if (0 !== f.length) {
                var e = f;
                f = [], a.call(e, function(e) {
                    e[0].add(e[1])
                }), s("Watching an undefined global, Ember expects watched globals to be setup by the time the run loop is flushed, check for typos", 0 === f.length)
            }
        };
        ...
        }, d = Ember._ChainNode = function(e, r, n) {
        ...
        b.value = function() {
            if (void 0 === this._value && this._watching) {
                ...
                this._value = e && !r(e) ? i(e, this._key) : void 0
            }
            return this._value
        }, b.destroy = function() {
            if (this._watching) {
            ...
            if (s = this._paths, s[t] = (s[t] || 0) + 1, r = this.value(), n = o(r, t), n[0] && n[0] === r) t = n[1], i = e(t), t = t.slice(i.length + 1);
                ...
                if (!n[0]) return f.push([this, t]), n.length = 0, void 0;
        ...
        }, b.count = 0, b.chain = function(t, r, n) {
            var i, o = this._chains;
            o || (o = this._chains = {}), i = o[t], i || (i = o[t] = new d(this, t, n)), i.count++, r && r.length > 0 && (t = e(r), r = r.slice(t.length + 1), i.chain(t, r))
        }, b.unchain = function(t, r) {
            var n = this._chains,
                i = n[t];
        ...
        }, b.chainWillChange = function(e, t, r) {
            this._key && (t = this._key + "." + t), this._parent ? this._parent.chainWillChange(this, t, r + 1) : (r > 1 && l(this.value(), t), t = "this." + t, this._paths[t] > 0 && l(this.value(), t))
        }, b.chainDidChange = function(e, t, r) {
            this._key && (t = this._key + "." + t), this._parent ? this._parent.chainDidChange(this, t, r + 1) : (r > 1 && h(this.value(), t), t = "this." + t, this._paths[t] > 0 && h(this.value(), t))
        }, b.didChange = function(e) {
            if (this._watching) {
    ...
    function() {
        ...
        Ember.destroy = function(e) {
            ...
            if (s && (e[n] = null, t = s.chains))
                for (m.push(t); m.length > 0;) {
                    if (t = m.pop(), r = t._chains)
                        for (o in r) r.hasOwnProperty(o) && m.push(r[o]);
    ...
    function() {
        function e(e, t) {
            var r = e[t];
            return r ? e.hasOwnProperty(t) || (r = e[t] = m(r)) : r = e[t] = {}, r
        }
        ...
        function r(r, n, i, o) {
            ...
            if (h)
                for (a = t(o), s = 0, u = h.length; u > s; s++) c = h[s], l = e(a, c), l[i] = (l[i] || 0) + 1, p(n, c)
        }

        function n(r, n, i, o) {
            var a, s, u, c, l, h = r._dependentKeys;
            if (h)
                for (a = t(o), s = 0, u = h.length; u > s; s++) c = h[s], l = e(a, c), l[i] = (l[i] || 0) - 1, d(n, c)
        }
        ...
        function o(e, t) {
            for (var r = {}, n = 0; t.length > n; n++) r[t[n]] = u(e, t[n]);
            return r
        }
        ...
        b.cacheable = function(e) {
        ...
        }, b.willWatch = function(e, t) {
            var n = e[f];
            t in n.cache || r(this, e, t, n)
        }, b.didUnwatch = function(e, t) {
            var r = e[f];
            ...
            var n, i, o;
            if (this._cacheable) {
                if (o = l(e), i = o.cache, t in i) return i[t];
                n = i[t] = this.func.call(e, t), o.watching[t] || r(this, e, t, o)
            } else n = this.func.call(e, t);
            return n
        }, b.set = function(e, t, n) {
            var i, o, a = this._cacheable,
                s = this.func,
                u = l(e, a),
                c = u.watching[t],
                h = this._suspended,
            ...
            this._suspended = e;
            try {
                if (a && f.hasOwnProperty(t) && (i = f[t], m = !0), s.wrappedFunction && (s = s.wrappedFunction), 3 === s.length) o = s.call(e, t, n, i);
                else {
                    if (2 !== s.length) return Ember.defineProperty(e, t, null, i), Ember.set(e, t, n), void 0;
                    o = s.call(e, t, n)
                } if (m && i === o) return;
                c && Ember.propertyWillChange(e, t), m && delete f[t], a && (c || m || r(this, e, t, u), f[t] = o), c && Ember.propertyDidChange(e, t)
            } finally {
                this._suspended = h
            }
            return o
            ...
            return Ember.isEmpty(u(this, e))
        }), a("notEmpty", function(e) {
            return !Ember.isEmpty(u(this, e))
        }), a("none", function(e) {
            return Ember.isNone(u(this, e))
        }), a("not", function(e) {
            return !u(this, e)
        }), a("bool", function(e) {
            return !!u(this, e)
            ...
            return Ember.computed(e, function(t, r) {
                return arguments.length > 1 ? (c(this, e, r), r) : u(this, e)
            })
        }, Ember.computed.defaultTo = function(e) {
            return Ember.computed(function(t, r, n) {
                return 1 === arguments.length ? null != n ? n : u(this, e) : null != r ? r : u(this, e)
            })
        }
    }(),
    function() {
        ...
        var r = ":change",
            n = ":before";
        Ember.guidFor, Ember.addObserver = function(t, r, n, i) {
    ...
    function() {
        function e(e, t, r, n) {
            return void 0 === t && (t = e, e = void 0), "string" == typeof t && (t = e[t]), r && n > 0 && (r = r.length > n ? o.call(r, n) : null), Ember.handleErrors(function() {
                return t.apply(e || this, r || [])
            }, this)
        }

        function t() {
            c = null, u.currentRunLoop && u.end()
        }
            ...
            l = null, u(function() {
                ...
                for (var i in m)
                    if (m.hasOwnProperty(i)) {
                        var o = m[i];
                        o && o.expires && (t >= o.expires ? (delete m[i], e(o.target, o.method, o.args, 2)) : (0 > n || n > o.expires) && (n = o.expires))
                    }
                n > 0 && (l = setTimeout(r, n - t), h = n)
            })
        }

        function n(t, r) {
            r[this.tguid] && delete r[this.tguid][this.mguid], m[t] && e(this.target, this.method, this.args), delete m[t]
        }

        function i(e, t, r, i) {
            var o, a = Ember.guidFor(t),
                s = Ember.guidFor(r),
                c = u.autorun().onceTimers,
                l = c[a] && c[a][s];
            return l && m[l] ? m[l].args = i : (o = {
                target: t,
                method: r,
                args: i,
                tguid: a,
                mguid: s
            }, l = Ember.guidFor(o), m[l] = o, c[a] || (c[a] = {}), c[a][s] = l, u.schedule(e, o, n, l, c)), l
        }
        var o = [].slice,
            a = Ember.ArrayPolyfills.forEach,
            s = function(e) {
        ...
        s.prototype = {
            ...
            schedule: function(e, t, r) {
                ...
                var a = arguments.length > 3 ? o.call(arguments, 3) : null;
                return n.push({
                    target: t,
                    method: r,
                    args: a
            ...
            flush: function(t) {
                ...
                if (Ember.watch.flushPending(), t)
                    for (; this._queues && (u = this._queues[t]);) this._queues[t] = null, "sync" === t ? (c = Ember.LOG_BINDINGS, c && Ember.Logger.log("Begin: Flush Sync Queue"), Ember.beginPropertyChanges(), Ember.tryFinally(n, Ember.endPropertyChanges), c && Ember.Logger.log("End: Flush Sync Queue")) : a.call(u, r);
                else {
                    i = Ember.run.queues, s = i.length, o = 0;
                    e: for (; s > o;) {
                        t = i[o], u = this._queues && this._queues[t], delete this._queues[t], u && ("sync" === t ? (c = Ember.LOG_BINDINGS, c && Ember.Logger.log("Begin: Flush Sync Queue"), Ember.beginPropertyChanges(), Ember.tryFinally(n, Ember.endPropertyChanges), c && Ember.Logger.log("End: Flush Sync Queue")) : a.call(u, r));
                        for (var l = 0; o >= l; l++)
        ...
        }, Ember.RunLoop = s, Ember.run = function(t, r) {
            function n() {
                return t || r ? e(t, r, i, 2) : void 0
            }
            var i = arguments;
            return u.begin(), Ember.tryFinally(n, u.end)
        };
        var u = Ember.run;
        Ember.run.begin = function() {
            u.currentRunLoop = new s(u.currentRunLoop)
        }, Ember.run.end = function() {
            function e() {
                u.currentRunLoop.end()
            }

            function t() {
                u.currentRunLoop = u.currentRunLoop.prev()
            }
        ...
        Ember.run.hasScheduledTimers = function() {
            ...
            c && (clearTimeout(c), c = null), l && (clearTimeout(l), l = null), m = {}
        }, Ember.run.autorun = function() {
            return u.currentRunLoop || (u.begin(), c || (c = setTimeout(t, 1))), u.currentRunLoop
        }, Ember.run.sync = function() {
            u.autorun(), u.currentRunLoop.flush("sync")
        };
        var l, h, m = {};
        Ember.run.later = function(e, t) {
            var n, i, a, s, u;
            return 2 === arguments.length && "function" == typeof e ? (u = t, t = e, e = void 0, n = [e, t]) : (n = o.call(arguments), u = n.pop()), i = +new Date + u, a = {
                target: e,
                method: t,
                expires: i,
                args: n
            }, s = Ember.guidFor(a), m[s] = a, l && h > i && (clearTimeout(l), l = null), l || (l = setTimeout(r, u), h = i), s
            ...
            return e.push(1), u.later.apply(this, e)
    ...
    function() {
        ...
        function n(e, t) {
            var r;
            return t instanceof g ? (r = P(t), e[r] ? V : (e[r] = t, t.properties)) : t
        }
        ...
        function u(e, t, n, i, u, c, l) {
            if (n instanceof Ember.Descriptor) {
                if (n === y && u[t]) return V;
                n.func && (n = o(i, t, n, c, u)), u[t] = n, c[t] = void 0
            } else r(n) ? n = a(e, t, n, c, u) : (l && C.call(l, t) >= 0 || "concatenatedProperties" === t) && (n = s(e, t, n, c)), u[t] = void 0, c[t] = n
        }
        ...
        function c(e, t, r, o, a, s) {
            ...
            for (var h, m, f, p, d, b = 0, E = e.length; E > b; b++)
                if (h = e[b], m = n(t, h), m !== V)
                    if (m) {
                        d = Ember.meta(a), p = i(m, o, a);
                        for (f in m) m.hasOwnProperty(f) && (s.push(f), u(a, f, m[f], d, r, o, p));
                        m.hasOwnProperty("toString") && (a.toString = m.toString)
                    } else h.mixins && (c(h.mixins, t, r, o, a, s), h._without && O.call(h._without, l))
        }
        ...
        function d(e, t, r) {
            var n = e[t];
            p(e, t, n, "__ember_observesBefore__", "removeBeforeObserver"), p(e, t, n, "__ember_observes__", "removeObserver"), p(e, t, r, "__ember_observesBefore__", "addBeforeObserver"), p(e, t, r, "__ember_observes__", "addObserver")
        }

        function b(t, r, n) {
            var i, o, a, s = {}, u = {}, h = Ember.meta(t),
                p = [];
            c(r, e(t), s, u, t, p);
            for (var b = 0, E = p.length; E > b; b++)
                if (i = p[b], "constructor" !== i && u.hasOwnProperty(i) && (a = s[i], o = u[i], a !== y)) {
                    for (; a && a instanceof w;) {
                        var v = f(t, a, h, s, u);
                        a = v.desc, o = v.value
                    }(void 0 !== a || void 0 !== o) && (d(t, i, o), l(t, i, o, h), A(t, i, a, o, h))
                }
            return n || m(t, h), t
        }
        ...
        function E(e, t, r) {
            ...
            for (var i = e.mixins, o = i ? i.length : 0; --o >= 0;)
                if (E(i[o], t, r)) return !0;
            return !1
        }

        function v(e, t, r) {
            if (!r[P(t)])
                if (r[P(t)] = !0, t.properties) {
                    var n = t.properties;
        ...
        var g, y, w, _ = Ember.ArrayPolyfills.map,
            ...
            P = Ember.guidFor,
            V = {}, T = Ember.IS_BINDING = /^.+Binding$/;
        Ember.mixin = function(e) {
            var t = S.call(arguments, 1);
            return b(e, t, !1), e
        }, Ember.Mixin = function() {
            return t(this, arguments)
        }, g = Ember.Mixin, g.prototype = {
            properties: null,
            mixins: null,
            ownerConstructor: null
        }, g._apply = b, g.applyPartial = function(e) {
            var t = S.call(arguments, 1);
            return b(e, t, !0)
        ...
        e("rsvp", [], function() {
            ...
            function r(e) {
                ...
                var o = function(e) {
                    return function(t) {
                        ...
                        r[e] = t, 0 === --i && n.resolve(r)
                    }, s = function(e) {
                        n.reject(e)
                    };
                for (t = 0; i > t; t++) e[t].then(o(t), s);
                return n
            }
            var n, i, o = "undefined" != typeof window ? window : {}, a = o.MutationObserver || o.WebKitMutationObserver;
            if ("undefined" != typeof process && "[object process]" === {}.toString.call(process)) i = function(e, t) {
                ...
                u.observe(c, {
                    ...
                    s.push([e, t]), c.setAttribute("drainQueue", "drainQueue")
                }
            } else i = function(e, t) {
                setTimeout(function() {
                    e.call(t)
            ...
            var l = function(e, t) {
                ...
                for (var r in t) t.hasOwnProperty(r) && (this[r] = t[r])
                    ...
                    on: function(e, t, r) {
                        var n, i, o = m(this);
                        for (e = e.split(/\s+/), r = r || this; i = e.shift();) n = o[i], n || (n = o[i] = []), -1 === h(n, t) && n.push([t, r])
                    },
                    off: function(e, t) {
                        var r, n, i, o = m(this);
                        for (e = e.split(/\s+/); n = e.shift();) t ? (r = o[n], i = h(r, t), -1 !== i && r.splice(i, 1)) : o[n] = []
                    },
                    trigger: function(e, t) {
                        var r, n, i, o, a, s = m(this);
                        if (r = s[e])
                            for (var u = 0; r.length > u; u++) n = r[u], i = n[0], o = n[1], "object" != typeof t && (t = {
                                detail: t
                            }), a = new l(e, t), i.call(o, a)
                    }
                }, p = function() {
                ...
                }, d = function() {}, b = function(e, t, r, n) {
                    var i, o, a, s, u = "function" == typeof r;
                    if (u) try {
                        i = r(n.detail), a = !0
                    } catch (c) {
                        s = !0, o = c
                    ...
                    i && "function" == typeof i.then ? i.then(function(e) {
                        ...
                        t.reject(e)
                    }) : u && a ? t.resolve(i) : s ? t.reject(o) : t[e](i)
                };
            return p.prototype = {
                then: function(e, t) {
                    var r = new p;
                    return this.isResolved && n.async(function() {
                        b("resolve", r, e, {
                            detail: this.resolvedValue
                        })
                    }, this), this.isRejected && n.async(function() {
                        b("reject", r, t, {
            ...
            }, f.mixin(p.prototype), n = {
                async: i,
                Promise: p,
                Event: l,
                EventTarget: f,
                all: r,
                raiseOnUncaughtExceptions: !0
            }
        })
    }(),
    function() {
        e("container", [], function() {
            ...
            function i(e, t) {
                var r = {};
                if (!t) return r;
                for (var n, i, o = 0, a = t.length; a > o; o++) n = t[o], i = e.lookup(n.fullName), r[n.property] = i;
                return r
            }
            ...
            function s(e, t) {
                var r, n = a(e, t),
                    s = t.split(":"),
                    u = s[0];
                if (o(e, t, "instantiate") === !1) return n;
                if (n) {
                    var c = [];
                    c = c.concat(e.typeInjections.get(u) || []), c = c.concat(e.injections[t] || []);
                    var l = i(e, c);
                    return l.container = e, l._debugContainerKey = t, r = n.create(l)
                }
            }
            ...
            return e.prototype = {
                ...
                register: function(e, t, r, n) {
                    var i; - 1 !== e.indexOf(":") ? (n = r, r = t, i = e) : i = e + ":" + t;
                ...
                injection: function(e, t, n) {
                    if (this.parent && r("injection"), -1 === e.indexOf(":")) return this.typeInjection(e, t, n);
    ...
    function() {
        ...
        Ember.compare = function r(e, t) {
            ...
            var n = Ember.typeOf(e),
                ...
                o = Ember.Comparable;
            if (o) {
                if ("instance" === n && o.detect(e.constructor)) return e.constructor.compare(e, t);
            ...
            switch (n) {
                ...
                case "array":
                    for (var f = e.length, p = t.length, d = Math.min(f, p), b = 0, E = 0; 0 === b && d > E;) b = r(e[E], t[E]), E++;
            ...
            for (var n in e)
                if (e.hasOwnProperty(n)) {
                    if (t = e[n], "toString" === t) continue;
                    "function" === Ember.typeOf(t) && (t = "function() { ... }"), r.push(n + ": " + t)
                }
            return "{" + r.join(", ") + "}"
    ...
    function() {
        ...
        var t = Ember.get,
            r = (Ember.set, Ember.EnumerableUtils.map),
            n = Ember.cacheFor;
        Ember.Array = Ember.Mixin.create(Ember.Enumerable, {
            ...
            "[]": Ember.computed(function(e, r) {
                return void 0 !== r && this.replace(0, t(this, "length"), r), this
            }),
            firstObject: Ember.computed(function() {
            ...
            slice: function(r, n) {
                var i = Ember.A([]),
                    o = t(this, "length");
                for (e(r) && (r = 0), (e(n) || n > o) && (n = o), 0 > r && (r = o + r), 0 > n && (n = o + n); n > r;) i[i.length] = this.objectAt(r++);
                return i
            },
            indexOf: function(e, r) {
                var n, i = t(this, "length");
                for (void 0 === r && (r = 0), 0 > r && (r += i), n = r; i > n; n++)
                    if (this.objectAt(n, !0) === e) return n;
                return -1
            },
            ...
            addArrayObserver: function(e, r) {
                var n = r && r.willChange || "arrayWillChange",
                    ...
                    o = t(this, "hasArrayObservers");
                return o || Ember.propertyWillChange(this, "hasArrayObservers"), Ember.addListener(this, "@array:before", e, n), Ember.addListener(this, "@array:change", e, i), o || Ember.propertyDidChange(this, "hasArrayObservers"), this
            },
            removeArrayObserver: function(e, r) {
                var n = r && r.willChange || "arrayWillChange",
                    i = r && r.didChange || "arrayDidChange",
                    o = t(this, "hasArrayObservers");
                return o && Ember.propertyWillChange(this, "hasArrayObservers"), Ember.removeListener(this, "@array:before", e, n), Ember.removeListener(this, "@array:change", e, i), o && Ember.propertyDidChange(this, "hasArrayObservers"), this
            },
            hasArrayObservers: Ember.computed(function() {
                return Ember.hasListeners(this, "@array:change") || Ember.hasListeners(this, "@array:before")
            }),
            arrayContentWillChange: function(e, r, n) {
                void 0 === e ? (e = 0, r = n = -1) : (void 0 === r && (r = -1), void 0 === n && (n = -1)), Ember.isWatching(this, "@each") && t(this, "@each"), Ember.sendEvent(this, "@array:before", [this, e, r, n]);
                var i, o;
                if (e >= 0 && r >= 0 && t(this, "hasEnumerableObservers")) {
                    i = [], o = e + r;
                    for (var a = e; o > a; a++) i.push(this.objectAt(a))
                } else i = r;
            ...
            arrayContentDidChange: function(e, r, i) {
                ...
                if (e >= 0 && i >= 0 && t(this, "hasEnumerableObservers")) {
                    o = [], a = e + i;
                    for (var s = e; a > s; s++) o.push(this.objectAt(s))
                } else o = i;
                this.enumerableContentDidChange(r, o), Ember.sendEvent(this, "@array:change", [this, e, r, i]);
                var u = t(this, "length"),
    ...
    function() {
        ...
        Ember.Observable = Ember.Mixin.create({
            ...
            getProperties: function() {
                var t = {}, r = arguments;
                1 === arguments.length && "array" === Ember.typeOf(arguments[0]) && (r = arguments[0]);
    ...
    function() {
        ...
        Ember.set, Ember.TargetActionSupport = Ember.Mixin.create({
            ...
            triggerAction: function(t) {
                ...
                if (n && r) {
                    var o;
                    return o = n.send ? n.send.apply(n, [r, i]) : n[r].apply(n, [i]), o !== !1 && (o = !0), o
                }
                return !1
            }
        })
    ...
    function() {
        ...
        Ember.DeferredMixin = Ember.Mixin.create({
            ...
            resolve: function(e) {
                r(this, "promise").resolve(e)
            },
            reject: function(e) {
                r(this, "promise").reject(e)
            },
    ...
    function() {
        function e() {
            var e, t, o = !1,
                a = function() {
                    o || a.proto(), n(this, i, v), n(this, "_super", v);
                    var u = s(this);
                    if (u.proto = this, e) {
                        var l = e;
                        ...
                        for (var m = this.concatenatedProperties, f = 0, d = h.length; d > f; f++) {
                            ...
                            for (var y in g)
                                if (g.hasOwnProperty(y)) {
                                    ...
                                    if (_.test(y)) {
                                        var C = u.bindings;
                                        C ? u.hasOwnProperty("bindings") || (C = u.bindings = r(u.bindings)) : C = u.bindings = {}, C[y] = w
                                    }
                                    var O = u.descs[y];
                                    if (m && E(m, y) >= 0) {
                                        var S = this[y];
                                        w = S ? "function" == typeof S.concat ? S.concat(w) : Ember.makeArray(S).concat(w) : Ember.makeArray(w)
                                    }
                                    O ? O.set(this, y, w) : "function" != typeof this.setUnknownProperty || y in this ? b ? Ember.defineProperty(this, y, null, w) : this[y] = w : this.setUnknownProperty(y, w)
                                }
                        }
                    }
                    p(this, u), delete u.proto, c(this), this.init.apply(this, arguments)
                };
            return a.toString = m.prototype.toString, a.willReopen = function() {
                o && (a.PrototypeMixin = m.create(a.PrototypeMixin)), o = !1
        ...
        var r = (Ember.set, Ember.get, Ember.create),
            ...
            f = m._apply,
            p = m.finishPartial,
            d = m.prototype.reopen,
            b = Ember.ENV.MANDATORY_SETTER,
        ...
        g.toString = function() {
            ...
            isDestroying: !1,
            destroy: function() {
                return this._didCallDestroy ? void 0 : (this.isDestroying = !0, this._didCallDestroy = !0, h("destroy", this, this._scheduledDestroy), this)
            },
            willDestroy: Ember.K,
        ...
        }), g.PrototypeMixin.ownerConstructor = g, Ember.config.overridePrototypeMixin && Ember.config.overridePrototypeMixin(g.PrototypeMixin), g.__super__ = null;
        var y = m.create({
            ...
            reopen: function() {
                return this.willReopen(), d.apply(this.PrototypeMixin, arguments), this
            },
            reopenClass: function() {
                return d.apply(this.ClassMixin, arguments), f(this, arguments, !1), this
            },
            detect: function(e) {
        ...
        y.ownerConstructor = g, Ember.config.overrideClassMixin && Ember.config.overrideClassMixin(y), g.ClassMixin = y, y.apply(g), Ember.CoreObject = g
    }(),
    function() {
    ...
    function() {
        ...
        Ember.set, Ember.ArrayProxy = Ember.Object.extend(Ember.MutableArray, {
            ...
            _contentDidChange: Ember.observer(function() {
                r(this, "content"), this._setupContent()
            }, "content"),
            ...
            removeAt: function(n, i) {
                if ("number" == typeof n) {
                    ...
                    for (u.sort(function(e, t) {
                        return t - e
                    }), Ember.beginPropertyChanges(), o = 0; u.length > o; o++) this._replace(u[o], 1, t);
    ...
    function() {
        ...
        Ember.ObjectProxy = Ember.Object.extend({
            ...
            create: function() {
                var e, t, r, n, i, o;
                if (arguments.length) {
                    for (t = this.proto(), r = 0, n = arguments.length; n > r; r++) {
                        i = arguments[r];
                        for (o in i)!i.hasOwnProperty(o) || o in t || (e || (e = {}), e[o] = null)
                    }
    ...
    function() {
        ...
        function t(e, t, r, i, o) {
            ...
            for (var s, u; --o >= i;) {
                var c = e.objectAt(o);
                c && (Ember.removeBeforeObserver(c, t, r, "contentKeyWillChange"), Ember.removeObserver(c, t, r, "contentKeyDidChange"), u = n(c), s = a[u], s[s.indexOf(o)] = null)
            }
        }
        var r = (Ember.set, Ember.get),
            n = Ember.guidFor,
            i = Ember.EnumerableUtils.forEach,
            o = Ember.Object.extend(Ember.Array, {
                init: function(e, t, r) {
        ...
        Ember.EachProxy = Ember.Object.extend({
            ...
            unknownProperty: function(e) {
                var t;
                return t = new o(this._content, e, this), Ember.defineProperty(this, e, null, t), this.beginObservingContentKey(e), t
            },
            ...
            arrayDidChange: function(t, r, n, i) {
                var o, a, s = this._keys;
                a = i > 0 ? r + i : -1, Ember.beginPropertyChanges(this);
                for (o in s) s.hasOwnProperty(o) && (a > 0 && e(t, o, this, r, a), Ember.propertyDidChange(this, o));
    ...
    function() {
        ...
        var t = Ember.Mixin.create(Ember.MutableArray, Ember.Observable, Ember.Copyable, {
            ...
            replace: function(t, r, n) {
                ...
                if (this.arrayContentWillChange(t, r, i), n && 0 !== n.length) {
                    var o = [t, r].concat(n);
                    this.splice.apply(this, o)
    ...
    function() {
        var e = Ember.ENV.EMBER_LOAD_HOOKS || {}, t = {};
        ...
        Ember.SortableMixin = Ember.Mixin.create(Ember.MutableEnumerable, {
            ...
            orderBy: function(r, n) {
                ...
                return t(o, function(t) {
                    0 === i && (i = Ember.compare(e(r, t), e(n, t)), 0 === i || a || (i = -1 * i))
                }), i
            },
            destroy: function() {
        ...
        Ember.ArrayController = Ember.ArrayProxy.extend(Ember.ControllerMixin, Ember.SortableMixin, {
            ...
            controllerAt: function(t, r, n) {
                var i = e(this, "container"),
                    ...
                    a = o[t];
                if (a || (a = i.lookup("controller:" + n, {
                    singleton: !1
                }), o[t] = a), !a) throw new Error('Could not resolve itemController: "' + n + '"');
                return a.set("target", this), a.set("content", r), a
            },
    ...
    function() {
        ...
        e.prototype = {
            ...
            pushOpeningTag: function() {
                ...
                if (e) {
                    ...
                    var t, r, n = this.buffer,
                        ...
                        s = this.elementProperties,
                        u = this.elementStyle;
                    if (n += "<" + e, i && (n += ' id="' + this._escapeAttribute(i) + '"', this.elementId = null), o && (n += ' class="' + this._escapeAttribute(o.join(" ")) + '"', this.classes = null), u) {
                        n += ' style="';
                        for (r in u) u.hasOwnProperty(r) && (n += r + ":" + this._escapeAttribute(u[r]) + ";");
                        n += '"', this.elementStyle = null
                    }
                    if (a) {
                        for (t in a) a.hasOwnProperty(t) && (n += " " + t + '="' + this._escapeAttribute(a[t]) + '"');
                    ...
                    if (s) {
                        for (r in s)
                            if (s.hasOwnProperty(r)) {
                                var c = s[r];
                                (c || "number" == typeof c) && (n += c === !0 ? " " + r + '="' + r + '"' : " " + r + '="' + this._escapeAttribute(s[r]) + '"')
                            }
            ...
            _escapeAttribute: function(e) {
                ...
                return n.test(o) ? o.replace(r, i) : o
            }
        }
    }(),
    function() {
        ...
        Ember.set, Ember.String.fmt, Ember.EventDispatcher = Ember.Object.extend({
            ...
            _dispatchEvent: function(e, t, r, n) {
                var i = !0,
                    o = e[r];
                return "function" === Ember.typeOf(o) ? (i = o.call(e, t, n), t.stopPropagation()) : i = this._bubbleEvent(n, t, r), i
            },
            ...
            destroy: function() {
                ...
                return Ember.$(t).undelegate(".ember").removeClass("ember-application"), this._super()
            }
        })
    }(),
    function() {
    ...
    function() {
        ...
        var t = {}, r = Ember.get,
            ...
            s = Ember.computed(function() {
                ...
                return o(e, function(e) {
                    e.isVirtual ? t.pushObjects(r(e, "childViews")) : t.push(e)
        ...
        Ember.View = Ember.CoreView.extend({
            ...
            _parentViewDidChange: Ember.observer(function() {
                this.isDestroying || r(this, "parentView.controller") && !r(this, "controller") && this.notifyPropertyChange("controller")
            }, "_parentView"),
            ...
            invokeRecursively: function(e, t) {
                for (var r, n, i = t === !1 ? this._childViews : [this]; i.length;) {
                    r = i.slice(), i = [];
                    for (var o = 0, a = r.length; a > o; o++) n = r[o], e(n), n._childViews && i.push.apply(i, n._childViews)
                }
            },
            triggerRecursively: function(e) {
                for (var t, r, n = [this]; n.length;) {
                    t = n.slice(), n = [];
                    for (var i = 0, o = t.length; o > i; i++) r = t[i], r.trigger && r.trigger(e), r._childViews && n.push.apply(n, r._childViews)
                }
            },
            viewHierarchyCollection: function() {
                for (var e, t = new u([this]), r = 0; t.length > r; r++) e = t.objectAt(r), e._childViews && t.push.apply(t, e._childViews);
                return t
            },
            ...
            createChildView: function(e, t) {
                return e.isView && e._parentView === this ? e : (Ember.CoreView.detect(e) ? (t = t || {}, t._parentView = this, t.container = this.container, t.templateData = t.templateData || r(this, "templateData"), e = e.create(t), e.viewName && n(r(this, "concreteView"), e.viewName, e)) : (t && e.setProperties(t), r(e, "templateData") || n(e, "templateData", r(this, "templateData")), n(e, "_parentView", this)), e)
            },
        ...
        Ember.View.addMutationListener = function(e) {
            ...
            "value" === t || "string" !== n && ("number" !== n || isNaN(r)) ? "value" === t || "boolean" === n ? (void 0 === r && (r = null), r !== e.prop(t) && e.prop(t, r)) : r || e.removeAttr(t) : r !== e.attr(t) && e.attr(t, r)
        }, Ember.View.states = t
    }(),
    function() {
    ...
    function() {
        ...
        Ember.ContainerView = Ember.View.extend(Ember.MutableArray, {
            ...
            initializeViews: function(e, t, o) {
                i(e, function(e) {
                    n(e, "_parentView", t), r(e, "templateData") || n(e, "templateData", o)
                })
            },
            currentView: null,
    ...
    function() {
        ...
        Ember.String.fmt, Ember.CollectionView = Ember.ContainerView.extend({
            ...
            arrayDidChange: function(r, n, i, o) {
                var a, s, u, c, l = e(this, "itemViewClass"),
                    h = [];
                if ("string" == typeof l && (l = e(l)), c = r ? e(r, "length") : 0)
                    for (u = n; n + o > u; u++) s = r.objectAt(u), a = this.createChildView(l, {
                        content: s,
                        contentIndex: u
                    }), h.push(a);
                else {
                    var m = e(this, "emptyView");
                    if (!m) return;
                    var f = Ember.CoreView.detect(m);
                    m = this.createChildView(m), h.push(m), t(this, "emptyView", m), f && (this._createdEmptyView = m)
                }
                this.replace(n, 0, h)
            },
            createChildView: function(r, n) {
                r = this._super(r, n);
                var i = e(r, "tagName"),
                    o = null === i || void 0 === i ? Ember.CollectionView.CONTAINER_MAP[e(this, "tagName")] : i;
                return t(r, "tagName", o), r
            }
    ...
    function() {
        e("metamorph", [], function() {
            "use strict"; // Copyright: ©2011 My Company Inc. All rights reserved.
            var e = function() {}, t = 0,
                r = this.document,
                n = r && "createRange" in r && "undefined" != typeof Range && Range.prototype.createContextualFragment,
                i = r && function() {
            ...
            if (l = function() {
                ...
                var b = {
                    ...
                    _default: [0, "", ""]
                        ...
                        for (r = 0; o > r; r++)
                            if (n = e.childNodes[r], i = 1 === n.nodeType && E(n, t)) return i
                    }, v = function(e, t) {
                        var n = [];
                        ...
                        v(u, a + t + s);
                        for (var c = 0; o >= c; c++) u = u.firstChild;
                        if (i) {
                ...
                u = function(e, t) {
                    var n, i, o, a = y(r.getElementById(this.start)),
                        s = r.getElementById(this.end),
                        u = s.parentNode;
                    for (w(a, s), n = a.nextSibling; n;) {
                    ...
                    for (n = g(a.parentNode, e); n;) i = n.nextSibling, u.insertBefore(n, s), n = i
                }, c = function() {
                    ...
                    var t, n, i = r.getElementById(this.end),
                        o = i.nextSibling,
                        a = i.parentNode;
                    for (n = g(a, e); n;) t = n.nextSibling, a.insertBefore(n, o), n = t
                }, f = function(e) {
    ...
    function() {
        var e = Object.create || function(e) {
            ...
            }, t = this.Handlebars || Ember.imports && Ember.imports.Handlebars;
        t || "function" != typeof require || (t = require("handlebars")), Ember.Handlebars = e(t), Ember.Handlebars.helper = function(e, t) {
            Ember.View.detect(t) ? Ember.Handlebars.registerHelper(e, function(e, r) {
                return Ember.Handlebars.helpers.view.call(this, t, r)
        ...
        Ember.Handlebars.Compiler.prototype.mustache = function(e) {
            if (e.isHelper && "control" === e.id.string) e.hash = e.hash || new t.AST.HashNode([]), e.hash.pairs.push(["controlID", new t.AST.StringNode(r + n++)]);
            else if (e.params.length || e.hash);
            else {
                var i = new t.AST.IdNode(["_triageMustache"]);
                e.escaped || (e.hash = e.hash || new t.AST.HashNode([]), e.hash.pairs.push(["unescaped", new t.AST.StringNode("true")])), e = new t.AST.MustacheNode([i].concat([e.id]), e.hash, !e.escaped)
            }
            ...
            return Ember.Handlebars.template(o)
        })
    }(),
    function() {
        function e(e, t, r, i) {
            var o, a, s, u, c, l, h = r.length,
                m = i.data,
                f = m.view,
                p = i.hash,
                d = p.boundOptions;
            s = new Ember._SimpleHandlebarsView(null, null, !p.unescaped, m), s.normalizedValue = function() {
                var o, a = [];
                for (o in d) d.hasOwnProperty(o) && (c = n(e, d[o], m), s.path = c.path, s.pathRoot = c.root, p[o] = Ember._SimpleHandlebarsView.prototype.normalizedValue.call(s));
                for (u = 0; h > u; ++u) c = r[u], s.path = c.path, s.pathRoot = c.root, a.push(Ember._SimpleHandlebarsView.prototype.normalizedValue.call(s));
                return a.push(i), t.apply(e, a)
            }, f.appendChild(s), o = [];
            for (a in d) d.hasOwnProperty(a) && o.push(n(e, d[a], m));
            for (o = o.concat(r), u = 0, l = o.length; l > u; ++u) c = o[u], f.registerObserver(c.root, c.path, s, s.rerender)
        }
        ...
        }), Ember.Handlebars.registerBoundHelper = function(i, o) {
            function a() {
                var i, a, u, c, l, h = r.call(arguments, 0, -1),
                    m = h.length,
                    ...
                    b = f.hash,
                    E = d.view,
                    v = f.contexts && f.contexts[0] || this;
                b.boundOptions = {};
                for (l in b) b.hasOwnProperty(l) && Ember.IS_BINDING.test(l) && "string" == typeof b[l] && (b.boundOptions[l.slice(0, -7)] = b[l]);
                for (d.properties = [], c = 0; m > c; ++c) d.properties.push(h[c]), p.push(n(v, h[c], d));
                if (d.isUnbound) return t(this, o, p, f);
                if (0 === s.length) return e(v, o, p, f);
                i = p[0], a = i.root, u = i.path;
                var g = new Ember._SimpleHandlebarsView(u, a, !f.hash.unescaped, f.data);
                g.normalizedValue = function() {
                    var e = Ember._SimpleHandlebarsView.prototype.normalizedValue.call(g);
                    return o.call(E, e, f)
                }, E.appendChild(g), E.registerObserver(a, u, g, g.rerender);
                for (var y = 0, w = s.length; w > y; y++) E.registerObserver(a, u + "." + s[y], g, g.rerender)
            }
            var s = r.call(arguments, 2);
            a._rawFunction = o, Ember.Handlebars.registerHelper(i, a)
    ...
    function() {
        function e(e, t, r, n) {
            this.path = e, this.pathRoot = t, this.isEscaped = r, this.templateData = n, this.morph = o(), this.state = "preRender", this.updateId = null
        }
        var r = Ember.get,
            n = Ember.set,
    ...
    function() {
        ...
        function t(e, t, r, n, a, s) {
            ...
            if (u = o(d, e, h), "object" == typeof this) {
                if (h.insideGroup) {
                    ...
                    var b, E, v = i(d, e, t);
                    v = a(v), E = r ? d : v, n(v) ? b = m : f && (b = f), b(E, {
                        data: t.data
                    })
                } else {
                    var g = p.createChildView(Ember._HandlebarsBoundView, {
                        preserveContext: r,
                        shouldDisplayFunc: n,
                ...
                } if ("" !== u.path && (p.registerObserver(u.root, u.path, c), s))
                    for (l = 0; s.length > l; l++) p.registerObserver(u.root, u.path + "." + s[l], c)
        ...
        function r(e, t) {
            var r, n, a = t.data,
                s = a.view,
                u = this;
            if (r = o(u, e, a), "object" == typeof this) {
                if (a.insideGroup) {
                    n = function() {
                        Ember.run.once(s, "rerender")
                    };
                    var c = i(u, e, t);
                    (null === c || void 0 === c) && (c = ""), a.buffer.push(c)
                } else {
        ...
        s.registerHelper("_triageMustache", function(e, t) {
        ...
        }), s.registerHelper("with", function(r, n) {
            if (4 === arguments.length) {
                var i, a, s, c;
                if (n = arguments[3], i = arguments[2], a = arguments[0], Ember.isGlobalPath(a)) Ember.bind(n.data.keywords, i, a);
                else {
                    c = o(this, a, n.data), a = c.path, s = c.root;
            ...
            return u.bind.call(n.contexts[0], r, n)
        }), s.registerHelper("if", function(e, t) {
            return u.boundIf.call(t.contexts[0], e, t)
        }), s.registerHelper("unless", function(e, t) {
            var r = t.fn,
                n = t.inverse;
            return t.fn = n, t.inverse = r, u.boundIf.call(t.contexts[0], e, t)
        }), s.registerHelper("bindAttr", function(e) {
            var t = e.hash,
                r = e.data.view,
                n = [],
                u = this,
                ...
                l = t["class"];
            if (null !== l && void 0 !== l) {
                var h = s.bindClasses(this, l, r, c, e);
            ...
            return a.call(m, function(a) {
                var s, l = t[a];
                s = o(u, l, e.data);
                var h, m, f = "this" === l ? s.root : i(u, l, e),
                    p = Ember.typeOf(f);
                h = function h() {
                    var t = i(u, l, e),
                        n = r.$("[data-bindattr-" + c + "='" + c + "']");
                    return n && 0 !== n.length ? (Ember.View.applyAttributeBindings(n, a, t), void 0) : (Ember.removeObserver(s.root, s.path, m), void 0)
                }, "this" === l || s.isKeyword && "" === s.path || r.registerObserver(s.root, s.path, h), "string" === p || "number" === p && !isNaN(f) ? n.push(a + '="' + Handlebars.Utils.escapeExpression(f) + '"') : f && "boolean" === p && n.push(a + '="' + a + '"')
            }, this), n.push("data-bindattr-" + c + '="' + c + '"'), new s.SafeString(n.join(" "))
        }), s.bindClasses = function(e, t, r, n, s) {
            var u, c, l, h = [],
                m = function(e, t, r) {
                    var n, o = t.path;
            ...
            return a.call(t.split(" "), function(t) {
                var i, a, f, p, d = Ember.View._parsePropertyPath(t),
                    b = d.path,
                    E = e;
                "" !== b && "this" !== b && (p = o(e, b, s.data), E = p.root, b = p.path), a = function() {
                    u = m(e, d, s), l = n ? r.$("[data-bindattr-" + n + "='" + n + "']") : r.$(), l && 0 !== l.length ? (i && l.removeClass(i), u ? (l.addClass(u), i = u) : i = null) : Ember.removeObserver(E, b, f)
                }, "" !== b && "this" !== b && r.registerObserver(E, b, a), c = m(e, d, s), c && (h.push(c), i = c)
            }), h
        }
    }(),
    function() {
        ...
        e.ViewHelper = Ember.Object.create({
            ...
            helper: function(t, r, n) {
                var i, o = n.data,
                    a = n.fn;
                i = "string" == typeof r ? e.get(t, r, n) : r;
                var s = this.propertiesFromHTMLOptions(n, t),
                    u = o.view;
                s.templateData = o;
                var c = i.proto ? i.proto() : i;
                a && (s.template = a), c.controller || c.controllerBinding || s.controller || s.controllerBinding || (s._context = t), u.appendChild(i, s)
            }
    ...
    function() {
        ...
        Ember.String.fmt, Ember.Handlebars.registerHelper("collection", function(r, n) {
            ...
            n.data.view;
            var s;
            s = r ? t(this, r, n) : Ember.CollectionView;
            var u, c, l = n.hash,
                h = {}, m = l.itemViewClass,
                f = s.proto();
            delete l.itemViewClass, c = m ? t(f, m, n) : f.itemViewClass;
            for (var p in l) l.hasOwnProperty(p) && (u = p.match(/^item(.)(.*)$/), u && "itemController" !== p && (h[u[1].toLowerCase() + u[2]] = l[p], delete l[p]));
            i && (h.template = i, delete n.fn);
            var d;
            a && a !== Handlebars.VM.noop ? (d = e(f, "emptyViewClass"), d = d.extend({
                template: a,
                tagName: h.tagName
            })) : l.emptyViewClass && (d = t(this, l.emptyViewClass, n)), d && (l.emptyView = d), l.keyword || (h._context = Ember.computed.alias("content"));
            var b = Ember.Handlebars.ViewHelper.propertiesFromHTMLOptions({
                data: o,
                hash: h
            }, this);
            return l.itemViewClass = c.extend(b), Ember.Handlebars.helpers.view.call(this, s, n)
        })
    }(),
    function() {
        ...
        Ember.Handlebars.EachView = Ember.CollectionView.extend(Ember._Metamorph, {
            init: function() {
                ...
                if (n) {
                    ...
                    t(i, "itemController", n), t(i, "container", e(this, "controller.container")), t(i, "_eachView", this), t(i, "target", e(this, "controller")), this.disableContentObservers(function() {
    ...
    function() {
        ...
        Ember.set, Ember.Handlebars.registerHelper("yield", function(t) {
            for (var r, n = t.data.view; n && !e(n, "layout");) n = e(n, "parentView");
    ...
    function() {
        function e(e, r, n) {
            var i = t(r, "action"),
                o = t(r, "onEvent");
            if (i && o === e) {
                var a = t(r, "controller"),
                    s = t(r, "value"),
                    u = t(r, "bubbles");
                a.send(i, s, r), u || n.stopPropagation()
            }
        }
        var t = Ember.get;
    ...
    function() {
        ...
        Ember.Handlebars.compile, Ember.SelectOption = Ember.View.extend({
            ...
            defaultTemplate: Ember.Handlebars.template(function(e, t, r, n, i) {
                function o(e, t) {
                    var n, i = "";
                    return t.buffer.push('<option value="">'), n = {}, t.buffer.push(l(r._triageMustache.call(e, "view.prompt", {
                        hash: {},
                        contexts: [e],
                        types: ["ID"],
                        hashTypes: n,
                ...
                function a(e, t) {
                    ...
                    }, t.buffer.push(l(r.view.call(e, "view.optionView", {
                        hash: {
                            contentBinding: "this"
                        },
                        contexts: [e],
                ...
                this.compilerInfo = [2, ">= 1.0.0-rc.3"], r = r || Ember.Handlebars.helpers, i = i || {};
                var s, u, c = "",
                    l = this.escapeExpression,
                    h = this;
                return u = {}, s = r["if"].call(t, "view.prompt", {
                    hash: {},
                    inverse: h.noop,
                    fn: h.program(1, o, i),
                    contexts: [t],
                    ...
                    hashTypes: u,
                    data: i
                }), (s || 0 === s) && i.buffer.push(s), u = {}, s = r.each.call(t, "view.content", {
                    hash: {},
                    inverse: h.noop,
                    fn: h.program(3, a, i),
                    contexts: [t],
            ...
            selectionDidChange: Ember.observer(function() {
                ...
                if (t(this, "multiple")) {
                    if (!o(r)) return e(this, "selection", Ember.A([r])), void 0;
            ...
            _changeMultiple: function() {
                ...
                if (s && r) {
                    var c = r.map(function() {
                        ...
                        l = s.objectsAt(c);
                    o(u) ? i(u, 0, t(u, "length"), l) : e(this, "selection", l)
                }
            },
    ...
    function() {
        ...
        Ember.Handlebars.registerHelper("input", function(t) {
            var r = t.hash,
                ...
                i = r.type,
                o = r.on;
            return delete r.type, delete r.on, e(r, n), "checkbox" === i ? Ember.Handlebars.helpers.view.call(this, Ember.Checkbox, t) : (r.type = i, r.onEvent = o || "enter", Ember.Handlebars.helpers.view.call(this, Ember.TextField, t))
        ...
        e("route-recognizer", [], function() {
            ...
            function u(e, t) {
                for (var r = e.handlers, n = e.regex, i = t.match(n), o = 1, a = [], s = 0, u = r.length; u > s; s++) {
                    for (var c = r[s], l = c.names, h = {}, m = 0, f = l.length; f > m; m++) h[l[m]] = i[o++];
                    a.push({
                        handler: c.handler,
                        params: h,
                        isDynamic: !! l.length
            ...
            function p(e, t, r, n) {
                ...
                for (var o in i)
                    if (i.hasOwnProperty(o)) {
                        var a = e.slice();
                        f(a, o, i[o]), t.children[o] ? p(a, t.children[o], r, n) : r.call(n, a)
                    }
            }
            var d = ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\"],
                b = new RegExp("(\\" + d.join("|\\") + ")", "g");
            e.prototype = {
                eachChar: function(e) {
            ...
            return E.prototype = {
                ...
                recognize: function(e) {
                    var t, r, n = [this.rootState],
                        i = e.length;
                    for ("/" !== e.charAt(0) && (e = "/" + e), i > 1 && "/" === e.charAt(i - 1) && (e = e.substr(0, i - 1)), t = 0, r = e.length; r > t && (n = s(n, e.charAt(t)), n.length); t++);
                    var o = [];
                    for (t = 0, r = n.length; r > t; t++) n[t].handlers && o.push(n[t]);
                    n = a(o);
                    var c = o[0];
        ...
        e("router", ["route-recognizer"], function(e) {
            ...
            function s(e, t, r, a) {
                function c(n) {
                    ...
                    var i = a.concat([{
                        context: n,
                        name: p.handler,
                        handler: e.getHandler(p.handler),
                ...
                if (t.length === r) {
                    var l = a[a.length - 1],
                        h = l && l.handler;
                    if (!h || !h.additionalHandler) return i(e), u(e, a), void 0;
                    var f = {
                        handler: h.additionalHandler(),
                        params: {},
                        isDynamic: !1
                    };
                    t.push(f)
                ...
                var p = t[r],
                    d = e.getHandler(p.handler),
                    b = d.deserialize && d.deserialize(p.params);
                b && "function" == typeof b.then ? (n(e), b.then(c).then(null, function(t) {
                    o(e, t)
                })) : c(b)
            }

            function u(e, t) {
                var r = l(e.currentHandlerInfos || [], t);
                e.currentHandlerInfos = t, c(r.exited, function(e) {
                    delete e.context, e.exit && e.exit()
                }), c(r.updatedContext, function(e, t) {
                    m(e, t), e.setup && e.setup(t)
                });
                var n = !1;
                c(r.entered, function(e, t) {
                    n || (e.enter && e.enter(), m(e, t), e.setup && !1 === e.setup(t) && (n = !0))
                }), !n && e.didTransition && e.didTransition(t)
            }
            ...
            function l(e, t) {
                ...
                for (i = 0, o = t.length; o > i; i++) {
                    var s = e[i],
                        u = t[i];
                    s && s.handler === u.handler || (r = !0), r ? (a.entered.push(u), s && a.exited.unshift(s)) : (n || s.context !== u.context) && (n = !0, a.updatedContext.push(u))
                }
            ...
            function h(e, t) {
                var r = e.currentHandlerInfos,
                    n = t.shift();
                if (!r) throw new Error("Could not trigger event '" + n + "'. There are no active handlers");
                for (var i = r.length - 1; i >= 0; i--) {
                    var o = r[i],
                        a = o.handler;
                    if (a.events && a.events[n]) return a.events[n].apply(a, t), void 0
                }
                throw new Error("Nothing handled the event '" + n + "'.")
            }
            ...
            return t.prototype = {
                ...
                _paramsForHandler: function(e, t, n) {
                    var i, o, a, s, u, c, l = this.recognizer.handlersFor(e),
                        h = {}, f = [],
                        p = l.length,
                        d = t.length;
                    for (c = l.length - 1; c >= 0 && d > 0; c--) l[c].names.length && (d--, p = c);
                    if (d > 0) throw "More context objects were passed than there are dynamic segments for the route: " + e;
                    for (c = 0; l.length > c; c++)
                        if (a = l[c], s = this.getHandler(a.handler), u = a.names, o = !1, u.length ? (c >= p ? (i = t.shift(), o = !0) : i = s.context, s.serialize && r(h, s.serialize(i, u))) : n && (c > p || !s.hasOwnProperty("context") ? s.deserialize && (i = s.deserialize({}), o = !0) : i = s.context), n && o && m(s, i), f.push({
                            isDynamic: !! a.names.length,
                            name: a.handler,
                            handler: s,
                            context: i
                        }), c === l.length - 1) {
                            var b, E = f[f.length - 1];
                            (b = E.handler.additionalHandler) && l.push({
                                handler: b.call(E.handler),
                                names: []
                            })
                        }
                    return {
                ...
                isActive: function(e) {
                    for (var t, r, n = [].slice.call(arguments, 1), i = this.currentHandlerInfos, o = !1, a = i.length - 1; a >= 0; a--)
                        if (r = i[a], r.name === e && (o = !0), o) {
                            if (0 === n.length) break;
    ...
    function() {
        Ember.controllerFor = function(e, t, r, n) {
            return e.lookup("controller:" + t, n) || Ember.generateController(e, t, r)
        }, Ember.generateController = function(e, t, r) {
            var n, i, o;
            return r && Ember.isArray(r) ? (i = e.resolve("controller:array"), n = i.extend({
                content: r
            })) : r ? (i = e.resolve("controller:object"), n = i.extend({
                content: r
            })) : (i = e.resolve("controller:basic"), n = i.extend()), n.toString = function() {
                return "(generated " + t + " controller)"
            }, o = "controller:" + t, e.register(o, n), e.lookup(o)
        }
    }(),
    function() {
        function e(e) {
            var t = s(e, "location"),
                r = s(e, "rootURL"),
                n = {};
            "string" == typeof r && (n.rootURL = r), "string" == typeof t && (n.implementation = t, t = u(e, "location", Ember.Location.create(n)))
        }

        function r(e) {
            var t = {}, r = e.container,
                n = r.resolve("route:basic");
            return function(i) {
                var o = "route:" + i,
                    a = r.lookup(o);
                if (t[i]) return a;
                if (t[i] = !0, !a) {
                    ...
                    r.register(o, n.extend()), a = r.lookup(o)
                }
                return a.routeName = i, a
            }
        }
        ...
        function o(e, t, r) {
            var n, i = r[0];
            n = e.router.hasRoute(r[0]) ? i : r[0] = i + ".index", e.router[t].apply(e.router, r), e.notifyPropertyChange("url")
        }
        var a = t("router"),
            s = Ember.get,
            u = Ember.set,
            c = Ember._MetamorphView;
        Ember.Router = Ember.Object.extend({
            ...
            startRouting: function() {
                ...
                var e = this.router,
                    ...
                    r = this.container,
                    n = this;
                i(this, e, t), r.register("view:default", c), r.register("view:toplevel", Ember.View.extend()), t.onUpdateURL(function(e) {
                    n.handleURL(e)
            ...
            didTransition: function(e) {
                var t = this.container.lookup("controller:application"),
                    r = n(e);
                u(t, "currentPath", r), this.notifyPropertyChange("url"), s(this, "namespace").LOG_TRANSITIONS && Ember.Logger.log("Transitioned into '" + r + "'")
            },
            handleURL: function(e) {
            ...
            transitionTo: function() {
                var e = [].slice.call(arguments);
                o(this, "transitionTo", e)
            },
            replaceWith: function() {
                var e = [].slice.call(arguments);
                o(this, "replaceWith", e)
            },
            generate: function() {
    ...
    function() {
        function e(e) {
            for (var t, r, n = e.router.router.currentHandlerInfos, i = 0, o = n.length; o > i; i++) {
        ...
        function t(r) {
            var n, i = e(r);
            if (i) return (n = i.lastRenderedTemplate) ? n : t(i, !0)
        }

        function r(e, r, n, i) {
            i = i || {}, i.into = i.into ? i.into.replace(/\//g, ".") : t(e), i.outlet = i.outlet || "main", i.name = r, i.template = n;
            var o, a = i.controller;
            return a = i.controller ? i.controller : (o = e.container.lookup("controller:" + r)) ? o : e.routeName, "string" == typeof a && (a = e.container.lookup("controller:" + a)), i.controller = a, i
        }

        function n(e, t, r) {
            var n = r.into ? "view:default" : "view:toplevel";
            return e = e || t.lookup(n), u(e, "templateName") || (c(e, "template", r.template), c(e, "_debugTemplateName", r.name)), c(e, "renderedName", r.name), c(e, "controller", r.controller), e
        }
        ...
        function i(e, t, r) {
            if (r.into) {
                ...
                e.teardownView && e.teardownView(), e.router._connectActiveView(r.name, t), e.teardownView = o(t), t.appendTo(i)
            }
        }
        ...
        Ember.String.fmt, Ember.Route = Ember.Object.extend({
            ...
            setup: function(e) {
                ...
                var r = ++this._redirectDepth;
                void 0 === e ? this.redirect() : this.redirect(e), this._redirectDepth--, this._checkingRedirect = !1;
                var n = this._redirected;
                if (t && (this._redirected = null), n[r]) return !1;
                var i = this.controllerFor(this.routeName, e);
                i && (this.controller = i, c(i, "model", e)), this.setupControllers ? this.setupControllers(i, e) : this.setupController(i, e), this.renderTemplates ? this.renderTemplates(e) : this.renderTemplate(i, e)
            },
            redirect: Ember.K,
            ...
            serialize: function(e, t) {
                if (1 === t.length) {
                    var r = t[0],
                        n = {};
                    return n[r] = /_id$/.test(r) ? u(e, "id") : e, n
                }
            },
            ...
            render: function(e, t) {
                ...
                var o = this.container,
                    a = o.lookup("view:" + e),
                    s = o.lookup("template:" + e);
                (a || s) && (t = r(this, e, s, t), a = n(a, o, t), "main" === t.outlet && (this.lastRenderedTemplate = e), i(this, a, t))
            },
            willDestroy: function() {
                s(this)
            }
    ...
    function() {
        Ember.onLoad("Ember.Handlebars", function() {
            function e(e, i, o) {
                function a(e, t) {
                    return "controller" === i[t] ? e : Ember.ControllerMixin.detect(e) ? a(n(e, "model")) : e
                }
                var s = t(e, i, o);
                return r.call(s, a)
            }
    ...
    function() {
        ...
        Ember.set, Ember.String.fmt, Ember.onLoad("Ember.Handlebars", function() {
            ...
            function n(e, n, i) {
                var o, a = i || e.namedRoute;
                o = t(n, a);
                var s = [o];
                return s.concat(r(e.parameters))
            }
            var i = Ember.Router.resolveParams,
                o = Ember.ViewUtils.isSimpleClick,
                a = Ember.LinkView = Ember.View.extend({
                    tagName: "a",
                    namedRoute: null,
                    currentWhen: null,
                    title: null,
                    ...
                    active: Ember.computed(function() {
                        var t = this.get("router"),
                            ...
                            o = t.isActive.apply(t, [this.currentWhen].concat(n)) || t.isActive.apply(t, [i].concat(n));
    ...
    function() {
        Ember.get, Ember.set, Ember.onLoad("Ember.Handlebars", function(e) {
            e.OutletView = Ember.ContainerView.extend(Ember._Metamorph), e.registerHelper("outlet", function(t, r) {
                ...
                return r.data.view.set("outletSource", n), r.hash.currentViewBinding = "_view.outletSource._outlets." + t, e.helpers.view.call(this, e.OutletView, r)
            })
        })
    }(),
    function() {
        Ember.get, Ember.set, Ember.onLoad("Ember.Handlebars", function() {
            Ember.Handlebars.registerHelper("render", function(e, t, r) {
                ...
                2 === arguments.length && (r = t, t = void 0), "string" == typeof t && (s = Ember.Handlebars.get(r.contexts[1], t, r), u = {
                    singleton: !1
                }), e = e.replace(/\//g, "."), n = r.data.keywords.controller.container, i = n.lookup("router:main"), a = n.lookup("view:" + e) || n.lookup("view:default"), o = (o = r.hash.controller) ? n.lookup("controller:" + o, u) : Ember.controllerFor(n, e, s, u), o && s && o.set("model", s);
                var c = r.contexts[1];
                c && a.registerObserver(c, t, function() {
                    o.set("model", Ember.Handlebars.get(c, t, r))
    ...
    function() {
        Ember.onLoad("Ember.Handlebars", function() {
            ...
            var t = Ember.Router.resolveParams,
                ...
                i = n.get,
                o = n.SafeString,
                a = (Ember.get, Array.prototype.slice),
                s = n.ActionHelper = {
                    registeredActions: {}
                }, u = ["alt", "shift", "meta", "ctrl"],
                c = function(e, t) {
            ...
            s.registerAction = function(t, r, n) {
                var o = (++Ember.uuid).toString();
                return s.registeredActions[o] = {
                ...
                var c, l;
                i.target ? (c = this, l = i.target) : (t = r.data.keywords.controller) && (c = t), u.target = {
                    root: c,
                    target: l,
                    options: r
                }, u.bubbles = i.bubbles;
                var h = s.registerAction(e, u, i.allowedKeys);
    ...
    function() {
        if (Ember.ENV.EXPERIMENTAL_CONTROL_HELPER) {
            ...
            Ember.Handlebars.registerHelper("control", function(r, n, i) {
                ...
                var m = r.replace(/\//g, "."),
                    f = u.lookup("view:" + m) || u.lookup("view:default"),
                    p = u.lookup("controller:" + m),
                    d = u.lookup("template:" + r);
                t(p, "target", c), t(p, "model", a), i.hash.template = d, i.hash.controller = p, Ember.addObserver(this, n, o), f.one("willDestroyElement", this, function() {
                    Ember.removeObserver(this, n, o)
                }), Ember.Handlebars.helpers.view.call(this, f, i)
            })
        }
    }(),
    function() {
    ...
    function() {
        ...
        Ember.HashLocation = Ember.Object.extend({
            ...
            onUpdateURL: function(r) {
                ...
                Ember.$(window).bind("hashchange.ember-location-" + i, function() {
                    Ember.run(function() {
        ...
        Ember.HistoryLocation = Ember.Object.extend({
            ...
            onUpdateURL: function(e) {
                var t = Ember.guidFor(this),
                    n = this;
                Ember.$(window).bind("popstate.ember-location-" + t, function() {
        ...
        t.prototype.add = function(e) {
            ...
            if (this.map(e, t), r)
                if ("string" == typeof r) this.addEdge(e, r);
                    ...
                    for (i = 0; r.length > i; i++) this.addEdge(e, r[i]);
            if (n)
                if ("string" == typeof n) this.addEdge(n, e);
                else
                    for (i = 0; n.length > i; i++) this.addEdge(n[i], e)
        }, Ember.DAG = t
    }(),
    function() {
        var e = Ember.get,
    ...
    function() {
        ...
        var r = Ember.get,
            n = Ember.set,
            i = Ember.Application = Ember.Namespace.extend(Ember.DeferredMixin, {
                rootElement: "body",
                ...
                reset: function() {
                    Ember.run(this, function() {
                        Ember.run(r(this, "__container__"), "destroy"), this.buildContainer(), this._readinessDeferrals = 1, this.$(this.rootElement).removeClass("ember-application"), Ember.run.schedule("actions", this, function() {
                ...
                runInitializers: function() {
                    var e, t, n = r(this.constructor, "initializers"),
                        ...
                        o = new Ember.DAG,
                        a = this;
                    for (e = 0; n.length > e; e++) t = n[e], o.addEdges(t.name, t.initialize, t.before, t.after);
                ...
                setupEventDispatcher: function() {
                    var e = this.createEventDispatcher(),
                        t = r(this, "customEvents");
                    e.setup(t)
                },
                createEventDispatcher: function() {
                    var e = r(this, "rootElement"),
                        t = Ember.EventDispatcher.create({
                            rootElement: e
                        });
                    return n(this, "eventDispatcher", t), t
                },
                startRouting: function() {
                ...
                willDestroy: function() {
                    Ember.BOOTED = !1;
                    var e = r(this, "eventDispatcher");
                    e && e.destroy(), r(this, "__container__").destroy()
                },
        ...
        Ember.Application.reopenClass({
            ...
            buildContainer: function(r) {
                ...
                return Ember.Container.defaultContainer = Ember.Container.defaultContainer || n, n.set = Ember.set, n.normalize = t, n.resolver = e(r), n.optionsForType("view", {
                    singleton: !1
                    ...
                    instantiate: !1
                }), n.injection("router:main", "namespace", "application:main"), n.typeInjection("controller", "target", "router:main"), n.typeInjection("controller", "namespace", "application:main"), n.typeInjection("route", "router", "router:main"), n
            }
        }), Ember.runLoadHooks("Ember.Application", Ember.Application)
    }(),
    function() {
        function e(e) {
            for (var r, n = t(e, "needs"), i = t(e, "container"), o = !0, a = 0, s = n.length; s > a; a++) r = n[a], -1 === r.indexOf(":") && (r = "controller:" + r), i.has(r) || (o = !1);
            return o
        }
        var t = Ember.get;
        Ember.set;
        var r = Ember.Object.extend({
            controller: null,
            unknownProperty: function(e) {
                for (var r, n = t(this, "controller"), i = t(n, "needs"), o = n.get("container"), a = 0, s = i.length; s > a; a++)
                    if (r = i[a], r === e) return o.lookup("controller:" + e)
            }
        });
        Ember.ControllerMixin.reopen({
    ...
    function() {
        ...
        Ember.State = Ember.Object.extend(Ember.Evented, {
            ...
            init: function() {
                ...
                var n, i, o;
                if (r)
                    for (n in r) this.setupChild(r, n, r[n]);
                else {
                    r = {};
                    for (n in this) "constructor" !== n && (i = this[n]) && ((o = i.transitionTarget) && (this.eventTransitions[n] = o), this.setupChild(r, n, i));
                    t(this, "states", r)
                }
                t(this, "pathsCaches", {})
            },
            setPathsCache: function(t, r, n) {
                var i = Ember.guidFor(t.constructor),
                    o = e(this, "pathsCaches"),
                    a = o[i] || {};
                a[r] = n, o[i] = a
            },
            getPathsCache: function(t, r) {
                var n = Ember.guidFor(t.constructor),
            ...
            setupChild: function(r, n, i) {
                return i ? (i.isState ? t(i, "name", n) : Ember.State.detect(i) && (i = i.create({
                    name: n
                })), i.isState ? (t(i, "parentState", this), e(this, "childStates").pushObject(i), r[n] = i, i) : void 0) : !1
            },
            lookupEventTransition: function(e) {
                for (var t, r = this; r && !t;) t = r.eventTransitions[e], r = r.get("parentState");
                return t
            },
    ...
    function() {
        ...
        i.prototype = {
            ...
            matchContextsToStates: function(t) {
                for (var r, n, i = this.enterStates.length - 1, o = []; t.length > 0;) {
                    ...
                    n = e(r, "hasContext") ? t.pop() : null, o.unshift(n)
                }
                this.contexts = o
            },
        ...
        var o = function(t, n, i) {
            var s, u, c, l = this.enableLogging,
                h = i ? "unhandledEvent" : t,
                m = n[h];
            if (s = [].slice.call(arguments, 3), "function" == typeof m) return l && (i ? Ember.Logger.log(r("STATEMANAGER: Unhandled event '%@' being sent to state %@.", [t, e(n, "path")])) : Ember.Logger.log(r("STATEMANAGER: Sending event '%@' to state %@.", [t, e(n, "path")]))), c = s, i && c.unshift(t), c.unshift(this), m.apply(n, c);
            var f = e(n, "parentState");
            return f ? (u = s, u.unshift(t, f, i), o.apply(this, u)) : i ? void 0 : a.call(this, t, s, !0)
        }, a = function(t, r, n) {
                return r.unshift(t, e(this, "currentState"), n), o.apply(this, r)
            };
        Ember.StateManager = Ember.State.extend({
            ...
            unhandledEvent: function(t, r) {
                if (e(this, "errorOnUnhandledEvent")) throw new Ember.Error(this.toString() + " could not respond to event " + r + " in state " + e(this, "currentState.path") + ".")
            },
            getStateByPath: function(t, r) {
                for (var n = r.split("."), i = t, o = 0, a = n.length; a > o && (i = e(e(i, "states"), n[o]), i); o++);
                return i
            },
            findStateByPath: function(t, r) {
                for (var n; !n && t;) n = this.getStateByPath(t, r), t = e(t, "parentState");
                return n
            },
            getStatesInPath: function(t, r) {
                if (!r || "" === r) return void 0;
                for (var n, i, o = r.split("."), a = [], s = 0, u = o.length; u > s; s++) {
                    if (n = e(t, "states"), !n) return void 0;
                    if (i = e(n, o[s]), !i) return void 0;
                    t = i, a.push(i)
                }
                return a
            },
            ...
            transitionTo: function(t, r) {
                if (!Ember.isEmpty(t)) {
                    var n = r ? Array.prototype.slice.call(arguments, 1) : [],
                        o = e(this, "currentState") || this,
                        a = this.contextFreeTransition(o, t),
                        s = new i(a).normalize(this, n);
                    this.enterState(s), this.triggerSetupContext(s)
                }
            },
            contextFreeTransition: function(t, r) {
                var n = t.getPathsCache(this, r);
                if (n) return n;
                for (var i = this.getStatesInPath(t, r), o = [], a = t; a && !i;) {
                    if (o.unshift(a), a = e(a, "parentState"), !a && (i = this.getStatesInPath(this, r), !i)) return;
                    i = this.getStatesInPath(a, r)
                }
                for (; i.length > 0 && i[0] === o[0];) a = i.shift(), o.shift();
                var s = {
                    exitStates: o,
                    enterStates: i,
                    resolveState: a
                };
                return t.setPathsCache(this, r, s), s
            },
            ...
            enterState: function(r) {
                var i = this.enableLogging,
                    o = r.exitStates.slice(0).reverse();
                n.call(o, function(e) {
                    e.trigger("exit", this)
    ...
    function() {
        function e(e) {
            var t = new a;
            return Ember.run(EMBER_APP_BEING_TESTED, EMBER_APP_BEING_TESTED.handleURL, e), i(t, t.resolve), t
        }
        ...
        function n(e) {
            return Ember.$(".ember-application").find(e)
        }

        function i(e, t) {
            t || (t = e, e = null), stop();
            var r = setInterval(function() {
                var n = EMBER_APP_BEING_TESTED.__container__.lookup("router:main").router.isLoading;
                n || s || Ember.run.hasScheduledTimers() || Ember.run.currentRunLoop || (clearInterval(r), start(), Ember.run(e, t))
            }, 200)
        }
        var o, a = Ember.RSVP.Promise,
            s = 0;
        Ember.Application.reopen({
            ...
            injectTestHelpers: function() {
                Ember.$(document).ajaxStart(function() {
                    ...
                    s--
                }), window.visit = e, window.click = t, window.fillIn = r, o = window.find, window.find = n
            },
            removeTestHelpers: function() {
                window.visit = null, window.click = null, window.fillIn = null, window.find = o
            }
        })
    }()
